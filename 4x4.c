...
int main(){
	...
	grid = al_load_bitmap("4x4 grid.png");
...
void fillFields(){
	Fields[0].x0 = 0; Fields[0].y0 = 105; Fields[0].x1 = 125; Fields[0].y1 = 235;
	Fields[1].x0 = 170; Fields[1].y0 = 105; Fields[1].x1 = 285; Fields[1].y1 = 235;
	Fields[2].x0 = 325; Fields[2].y0 = 105; Fields[2].x1 = 440; Fields[2].y1 = 235;
	Fields[3].x0 = 480; Fields[3].y0 = 105; Fields[3].x1 = 600; Fields[3].y1 = 235;
	Fields[4].x0 = 0; Fields[4].y0 = 270; Fields[4].x1 = 130; Fields[4].y1 = 385;
	Fields[5].x0 = 170; Fields[5].y0 = 270; Fields[5].x1 = 285; Fields[5].y1 = 385;
	Fields[6].x0 = 325; Fields[6].y0 = 270; Fields[6].x1 = 440; Fields[6].y1 = 385;
	Fields[7].x0 = 480; Fields[7].y0 = 270; Fields[7].x1 = 600; Fields[7].y1 = 385;
	Fields[8].x0 = 0; Fields[8].y0 = 420; Fields[8].x1 = 132; Fields[8].y1 = 530;
	Fields[9].x0 = 170; Fields[9].y0 = 420; Fields[9].x1 = 285; Fields[9].y1 = 530;
	Fields[10].x0 = 325; Fields[10].y0 = 420; Fields[10].x1 = 440; Fields[10].y1 = 530;
	Fields[11].x0 = 480; Fields[11].y0 = 420; Fields[11].x1 = 600; Fields[11].y1 = 530;
	Fields[12].x0 = 0; Fields[12].y0 = 565; Fields[12].x1 = 125; Fields[12].y1 = 700;
	Fields[13].x0 = 170; Fields[13].y0 = 565; Fields[13].x1 = 285; Fields[13].y1 = 700;
	Fields[14].x0 = 325; Fields[14].y0 = 565; Fields[14].x1 = 440; Fields[14].y1 = 700;
	Fields[15].x0 = 480; Fields[15].y0 = 565; Fields[15].x1 = 600; Fields[15].y1 = 700;
}
...
void BasicGrid(const ALLEGRO_FONT *font, ALLEGRO_BITMAP *grid){
	...
	// Draw Title:
	al_draw_textf(font, BLUE, 300, 0, ALLEGRO_ALIGN_CENTER, "Tic Tac Toe 2.0 - Size: 4x4");
